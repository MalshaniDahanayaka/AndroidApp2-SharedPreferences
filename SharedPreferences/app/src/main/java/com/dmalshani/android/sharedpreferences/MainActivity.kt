package com.dmalshani.android.sharedpreferences
...
class MainActivity : AppCompatActivity() {
    ...
    private fun saveData(){
        ...
        changingText.text = "Your saved text : $textEntered"
        val booleanState = switch.isChecked
        state.text = "Your saved boolean state : $booleanState"
    ...
    private fun loadData(){
        ...
        changingText.text = "Your saved text: $savedString"
        switch.isChecked = savedBoolean
        booleanState.text = "Your saved boolean state : $savedBoolean"
